...
class LGRawframeDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.ann_skeleton_path = ann_skeleton_file
        super().__init__(
            ann_file,
            pipeline,
            data_prefix,
    ...
    def load_annotations(self):
        ...
        if self.ann_skeleton_path:
            skeleton = np.load(self.ann_skeleton_path)
            skeleton = np.transpose(skeleton, [0, 2, 3, 1, 4])
        with open(self.ann_file, 'r') as fin:
            ...
            for line in fin:
                ...
                video_info['skeleton'] = skeleton[line_number]
                line_number += 1
