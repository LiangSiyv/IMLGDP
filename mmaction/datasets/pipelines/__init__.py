...
from .pose_loading import (GeneratePoseTarget, LoadKineticsPose,
                           ...
                           UniformSampleFrames)
from .my_pipeline import (SkeletonGuide8Crop, SkeletonGuide4Crop, ResizeLocalImgs,
                          NormalizeLocalImgs, FormatShapeLocalImgs, CreateCropBoxes, FuseLocal, SaveOriginImgs,
                          Local_Flip, RandomSkeletonNoise)
...
__all__ = [
    ...
    'SkeletonGuide4Crop',
    'SkeletonGuide8Crop', 'ResizeLocalImgs', 'NormalizeLocalImgs',
    'FormatShapeLocalImgs', 'CreateCropBoxes', 'FuseLocal', 'SaveOriginImgs',
    'Local_Flip', 'RandomSkeletonNoise'
]