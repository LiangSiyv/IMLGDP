...
from .eightfc_head import EightFCHead
from .full_eightfc_2s_head import FullEightFC2sHead
from .onefc_head import OneFCHead
from .full_onefc_2s_head import FullOneFC2sHead
from .four2onefc_head import Four2OneFCHead
__all__ = [
    'TSNHead', 'I3DHead', 'BaseHead', 'TSMHead', 'SlowFastHead', 'SSNHead',
    'TPNHead', 'AudioTSNHead', 'X3DHead', 'BBoxHeadAVA', 'AVARoIHead',
    'FBOHead', 'LFBInferHead', 'TRNHead', 'TimeSformerHead', 'ACRNHead',
    'STGCNHead', 'EightFCHead', 'FullEightFC2sHead', 'OneFCHead',
    'FullOneFC2sHead', Four2OneFCHead
]
